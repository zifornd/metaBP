...
include { PRODIGAL as PRODIGAL_SPADES           } from '../modules/nf-core/modules/prodigal/main'            addParams( options: modules['prodigal']              )
include { PRODIGAL as PRODIGAL_MEGAHIT          } from '../modules/nf-core/modules/prodigal/main'            addParams( options: modules['prodigal']              )
