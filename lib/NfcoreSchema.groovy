...
class NfcoreSchema {
    ...
    public static String paramsSummaryLog(workflow, params) {
        ...
        output += "If faced with issues due to lack of disk space, use flag \'--max_memory\' to adjust memory usage.\n"
	output += "If faced with issues due to lack of CPUs, use flag \'--max_cpus\' to adjust the no. of CPUs used.\n\n"
